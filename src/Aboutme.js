          ...
          <div className={style.about}>
            ...
            <div className={'six columns'}>   
              <div className={style.myintro}> 
                  ...
                  <p>While I am not busy designing, I learn and experiment with new things. I believe learning is a treasure and the only way to keep up with this ever-changing world. Recently, amazed by the power of WebGL and the richness of content it can bring to the web, I’ve been creating my own <Link className={style.closebtn} to="/ThreejsExp">3D content</Link>.</p>
