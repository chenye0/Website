          ...
          <div className={style.about}>
            ...
            <div className={'six columns'}>   
              <div className={style.myintro}> 
                  ...
                  <p>Coming from a engineering background, I’ve always enjoy building things. I have created intelligent racing car as well as optical displacement sensor with nanometer precision. I designed electronic circuits to make magic happen on the printed circuit board.</p>
              ...
              <button><a href='https://drive.google.com/open?id=19152lISm5s70YAvs0JpqBjssiNMGjkaP'>View Resume</a></button>
            </div>  
          </div>
        </div>
      );
